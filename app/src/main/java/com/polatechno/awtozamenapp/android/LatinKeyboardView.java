package com.polatechno.awtozamenapp.android;
...
public class LatinKeyboardView extends KeyboardView {
    ...
    protected boolean onLongPress(Key key) {
        ...
        if (key.codes[0] == Keyboard.KEYCODE_CANCEL) {
            ...
            return true;
        } else if (((key.codes[0] == 'w' || key.codes[0] == 'W') && PolatovKeyboard.mActiveKeyboard == "en_US") || key.codes[0] == '۲') {
            ...
            return true;
        } else if (((key.codes[0] == 'r' || key.codes[0] == 'R') && PolatovKeyboard.mActiveKeyboard == "en_US") || key.codes[0] == '۴') {
            getOnKeyboardActionListener().onKey('4', null);
            return true;
        } else if (((key.codes[0] == 't' || key.codes[0] == 'T') && PolatovKeyboard.mActiveKeyboard == "en_US") || key.codes[0] == '۵') {
            ...
            return true;
        } else if ((key.codes[0] == 'S' || key.codes[0] == 's') && PolatovKeyboard.mActiveKeyboard == "en_US") {
            getOnKeyboardActionListener().onKey('ϐ', null);
            return true;

            // For Farsi Keyboard
        } else if (PolatovKeyboard.mActiveKeyboard == "fa_AF" && key.codes[0] == 'ض') {
            getOnKeyboardActionListener().onKey('۱', null);
            return true;
        } else if (PolatovKeyboard.mActiveKeyboard == "fa_AF" && key.codes[0] == 'ص') {
            getOnKeyboardActionListener().onKey('۲', null);
            return true;
        } else if (PolatovKeyboard.mActiveKeyboard == "fa_AF" && key.codes[0] == 'ث') {
            getOnKeyboardActionListener().onKey('۳', null);
            return true;
        } else if (PolatovKeyboard.mActiveKeyboard == "fa_AF" && key.codes[0] == 'ق') {
            getOnKeyboardActionListener().onKey('۴', null);
            return true;
        } else if (PolatovKeyboard.mActiveKeyboard == "fa_AF" && key.codes[0] == 'ف') {
            getOnKeyboardActionListener().onKey('۵', null);
            return true;
        } else if (PolatovKeyboard.mActiveKeyboard == "fa_AF" && key.codes[0] == 'غ') {
            getOnKeyboardActionListener().onKey('۶', null);
            return true;
        } else if (PolatovKeyboard.mActiveKeyboard == "fa_AF" && key.codes[0] == 'ع') {
            getOnKeyboardActionListener().onKey('۷', null);
            return true;
        } else if (PolatovKeyboard.mActiveKeyboard == "fa_AF" && key.codes[0] == 'ه') {
            getOnKeyboardActionListener().onKey('۸', null);
            return true;
        } else if (PolatovKeyboard.mActiveKeyboard == "fa_AF" && key.codes[0] == 'خ') {
            getOnKeyboardActionListener().onKey('۹', null);
            return true;
        } else if (PolatovKeyboard.mActiveKeyboard == "fa_AF" && key.codes[0] == 'ح') {
            getOnKeyboardActionListener().onKey('۰', null);
            return true;
        } else if (PolatovKeyboard.mActiveKeyboard == "fa_AF" && key.codes[0] == 'ش') {
            getOnKeyboardActionListener().onKey('ٴ', null);
            return true;

            // For Pashto Keyboard
        } else if (Objects.equals(PolatovKeyboard.mActiveKeyboard, "ps_AF") && key.codes[0] == 'ث') {
            getOnKeyboardActionListener().onKey('۲', null);
            return true;
        } else if (PolatovKeyboard.mActiveKeyboard == "ps_AF" && key.codes[0] == 'ق') {
            getOnKeyboardActionListener().onKey('۳', null);
            return true;
        } else if (PolatovKeyboard.mActiveKeyboard == "ps_AF" && key.codes[0] == 'ف') {
            getOnKeyboardActionListener().onKey('۴', null);
            return true;
        } else if (PolatovKeyboard.mActiveKeyboard == "ps_AF" && key.codes[0] == 'ځ') {
            getOnKeyboardActionListener().onKey('۵', null);
            return true;
        } else if (PolatovKeyboard.mActiveKeyboard == "ps_AF" && key.codes[0] == 'څ') {
            getOnKeyboardActionListener().onKey('۶', null);
            return true;
        } else if (PolatovKeyboard.mActiveKeyboard == "ps_AF" && key.codes[0] == 'خ') {
            getOnKeyboardActionListener().onKey('۷', null);
            return true;
        } else if (PolatovKeyboard.mActiveKeyboard == "ps_AF" && key.codes[0] == 'ح') {
            getOnKeyboardActionListener().onKey('۸', null);
            return true;
        } else if (PolatovKeyboard.mActiveKeyboard == "ps_AF" && key.codes[0] == 'چ') {
            getOnKeyboardActionListener().onKey('۹', null);
            return true;
        } else if (PolatovKeyboard.mActiveKeyboard == "ps_AF" && key.codes[0] == 'ج') {
            getOnKeyboardActionListener().onKey('۰', null);
            return true;
        } else if (PolatovKeyboard.mActiveKeyboard == "ps_AF" && key.codes[0] == 'ن') {
            getOnKeyboardActionListener().onKey('ڼ', null);
            return true;
        } else if (PolatovKeyboard.mActiveKeyboard == "ps_AF" && key.codes[0] == 'و') {
            getOnKeyboardActionListener().onKey('ؤ', null);
            return true;
        } else if (PolatovKeyboard.mActiveKeyboard == "ps_AF" && key.codes[0] == 'ط') {
            getOnKeyboardActionListener().onKey('ظ', null);
            return true;
        } else if (PolatovKeyboard.mActiveKeyboard == "ps_AF" && key.codes[0] == 'ټ') {
            getOnKeyboardActionListener().onKey('ة', null);
            return true;

            // For Latin Keys
        } else if (PolatovKeyboard.mActiveKeyboard != "en_US" && (key.codes[0] == 'w' || key.codes[0] == 'W')) {
            getOnKeyboardActionListener().onKey('1', null);
            return true;
        } else if (key.codes[0] == 'ə' || key.codes[0] == 'Ə') {
            getOnKeyboardActionListener().onKey('2', null);
            return true;
        } else if (PolatovKeyboard.mActiveKeyboard != "en_US" && key.codes[0] == 's') {
            getOnKeyboardActionListener().onKey('š', null);
            return true;
        } else if (PolatovKeyboard.mActiveKeyboard != "en_US" && key.codes[0] == 'd') {
            getOnKeyboardActionListener().onKey('ḍ', null);
            return true;
        } else if (PolatovKeyboard.mActiveKeyboard != "en_US" && key.codes[0] == 'z') {
            getOnKeyboardActionListener().onKey('ž', null);
            return true;
        } else if (PolatovKeyboard.mActiveKeyboard != "en_US" && key.codes[0] == 'c') {
            getOnKeyboardActionListener().onKey('č', null);
            return true;
        } else if (PolatovKeyboard.mActiveKeyboard != "en_US" && key.codes[0] == 'n') {
            getOnKeyboardActionListener().onKey('ṇ', null);
            return true;
        } else if (PolatovKeyboard.mActiveKeyboard != "en_US" && key.codes[0] == 'g') {
            getOnKeyboardActionListener().onKey('ǧ', null);
            return true;
        } else if (PolatovKeyboard.mActiveKeyboard != "en_US" && key.codes[0] == 'l') {
            getOnKeyboardActionListener().onKey('ɣ', null);
            return true;
        } else if (PolatovKeyboard.mActiveKeyboard != "en_US" && key.codes[0] == 'j') {
    ...
    public void onDraw(Canvas canvas) {
        ...
        for (Key key : keys) {
            if (key.label != null) {
                ...
                if (key.label.toString().equals("q") || key.label.toString().equals("Q") || key.label.toString().equals("۱"))
                ...
                else if (((key.codes[0] == 'w' || key.codes[0] == 'W') && PolatovKeyboard.mActiveKeyboard == "en_US") || key.label.toString().equals("۲"))
                    ...
                    // for Farsi keyboards.
                else if (PolatovKeyboard.mActiveKeyboard == "fa_AF") {
                    ...
                    // For Pashto Language
                } else if (PolatovKeyboard.mActiveKeyboard == "ps_AF") {
                    ...
                    // For Latin Pashto
                } else if (PolatovKeyboard.mActiveKeyboard == "ps_latin_AF" || PolatovKeyboard.mActiveKeyboard == "ps_latin_AF_Shift") {
                    if (key.label.toString().equals("w"))
                        ...
                        canvas.drawText(String.valueOf("0"), key.x + (key.width / 2) + 10, key.y + keyYLocation, paint);
                    } else if (PolatovKeyboard.mActiveKeyboard == "ps_latin_AF") {
                    ...
                    } else if (PolatovKeyboard.mActiveKeyboard == "ps_latin_AF_Shift") {
